...
pa<-ggplot(i, aes(fct_reorder(Departamento,w_mean), w_mean, fill=Departamento))+
  geom_col()+ 
  coord_flip()+
  labs(y="Artículos", subtitle="Promedio en el periodo 2017,2018,2019 y promedio por investigador por año ().", x="Departamento",title="Artículos tipo A por departamento académico.")+
  theme_light()+
