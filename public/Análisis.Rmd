...
La producción de libros es  fundamental en un centro de investigación, no obstante estos son proyectos de largo plazo y expresiones de la trayectoria academica que reflejan un cierto grado de consolidación y liderazgo en un tema. 
...
La distribución en horas de docencia actual únicametne refleja el diseño insttuional en el que tenemos una sede principal: Tijuana donde se concentran la gran mayoria de los programas docentes  y otras sedes que en su mayoria no cuantan con programas docentes.

Este diseño condicional el perfil de activiades docentes de lso docentes entre las sedes.

Considerando esta estructura el SIEVA establece provisiones que compensan esta desequilibrio estrucurral.  La via de evalaución con solo publicaciones encuentra su justificación en este hecho.
